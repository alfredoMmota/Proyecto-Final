...
void kutta::Limpiar(){// se define el funcionamiento del metodo Limpiar
    ui->liminf->setValue(0.0);//se restauran todos los valores  de los spinbox
...
//programa elaborado por Jose Alfredo Mendoza Mota, Gibran Omar Estrada Gomez, Ana Karen Razo Francisco y Jesus Antonio Herrera Diaz
